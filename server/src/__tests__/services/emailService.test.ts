...
import { emailService, verifyEmailConfig } from '../../services/emailService'
...
describe('Email Service', () => {
  ...
  describe('notifySubmission', () => {
    it('should send emails to monteur and superviseurs', async () => {
      ...
      await emailService.notifySubmission(mockFeuilleData, superviseurs)
    ...
    it('should include monteur name in email content', async () => {
      await emailService.notifySubmission(mockFeuilleData, [])
  ...
  describe('notifyValidation', () => {
    it('should send validation email to monteur', async () => {
      await emailService.notifyValidation(mockFeuilleData, 'supervisor@test.com')
    ...
    it('should include validator info in email content', async () => {
      await emailService.notifyValidation(mockFeuilleData, 'manager@test.com')
  ...
  describe('notifyRejection', () => {
    it('should send rejection email to monteur', async () => {
      await emailService.notifyRejection(mockFeuilleData, 'supervisor@test.com')
    ...
    it('should include rejection reason when provided', async () => {
      ...
      await emailService.notifyRejection(mockFeuilleData, 'supervisor@test.com', motif)
  ...
  describe('Error handling', () => {
    it('should handle sendMail errors gracefully', async () => {
      ...
      // Should not throw
      await expect(
        emailService.notifyValidation(mockFeuilleData, 'supervisor@test.com')
