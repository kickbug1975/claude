...
describe('Feuille Integration Tests', () => {
    ...
    describe('POST /api/feuilles', () => {
        it('should create a new feuille as monochrome', async () => {
            ...
            expect(response.body.data.statut).toBe(client_1.StatutFeuille.BROUILLON);
        });
    });
        ...
        it('should allow monteur to submit their own feuille', async () => {
            const feuille = await database_1.prisma.feuilleTravail.create({
                data: {
                    ...
                    statut: client_1.StatutFeuille.BROUILLON
                }
            });
            const response = await (0, supertest_1.default)(index_1.default)
    ...
    describe('POST /api/feuilles/:id/validate', () => {
        it('should validate a feuille if user is admin', async () => {
            ...
            const submitRes = await (0, supertest_1.default)(index_1.default)
...
//# sourceMappingURL=feuille.int.test.js.map