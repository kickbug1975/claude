...
describe('CSRF Middleware', () => {
    ...
    describe('generateCsrfToken', () => {
        ...
        it('should handle missing IP and User-Agent in getSessionId', () => {
            ...
            generateCsrfToken(minimalReq, mockResponse, nextFunction);
            expect(mockResponse.json).toHaveBeenCalledWith(expect.objectContaining({ success: true }));
        });
        it('should use remoteAddress if ip is missing', () => {
            const reqWithRemoteAddr = {
                headers: { 'user-agent': 'test' },
                socket: { remoteAddress: '1.2.3.4' }
            };
            generateCsrfToken(reqWithRemoteAddr, mockResponse, nextFunction);
            expect(mockResponse.json).toHaveBeenCalledWith(expect.objectContaining({ success: true }));
        });
    });
    describe('csrfProtection', () => {
        ...
        it('should accept POST request with valid token', () => {
            ...
            generateCsrfToken(mockRequest, resForGen, nextFunction);
    ...
    describe('csrfErrorHandler', () => {
        it('should handle EBADCSRFTOKEN error code', () => {
            ...
            csrfErrorHandler(error, mockRequest, mockResponse, nextFunction);
            expect(mockResponse.status).toHaveBeenCalledWith(403);
            expect(mockResponse.json).toHaveBeenCalledWith(expect.objectContaining({
