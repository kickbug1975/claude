...
describe('Error Handler', () => {
    ...
    describe('AppError', () => {
        it('should create an AppError with message and statusCode', () => {
            const error = new errorHandler_1.AppError('Test error', 400);
        ...
        it('should capture stack trace', () => {
            const error = new errorHandler_1.AppError('Test error', 500);
            expect(error.stack).toBeDefined();
        });
    });
    describe('errorHandler middleware', () => {
        it('should handle AppError with correct status code', () => {
            const error = new errorHandler_1.AppError('Not found', 404);
        ...
        it('should handle AppError with different status codes', () => {
            ...
            testCases.forEach(({ message, statusCode }) => {
                const error = new errorHandler_1.AppError(message, statusCode);
